...
<td width="30%" rowspan="2" style="vertical-align: middle;">
  <a href="javascript:Check_Value();" tabindex="3" 
     class="btn btn-sm btn-dark text-white mx-0"
     style="height:75px; width:75px; display: flex; align-items: center; justify-content: center;">
     로그인
  </a>
</td>
...
<tr height="50">
  <td align="center" valign="middle" style="vertical-align: middle;">
    <a href="member_idpw.php" class="btn btn-sm mybutton me-5">
      아이디 / 암호 찾기
    </a>
  </td>
</tr>
