...
$sql = "update juso set name='$name_esc', tel='$tel_esc', sm=$sm, birthday='$birthday_esc',
                juso='$juso_esc' where id=$id";
$result = mysqli_query($db, $sql);
if (!$result) {
    error_log("Juso update failed: " . mysqli_error($db));
    exit("주소 수정 처리 중 오류가 발생했습니다.");
}
