      ...
      if (!$db) exit("DB연결에러");
			...
			$zip_kind = isset($_REQUEST['zip_kind']) ? (int)$_REQUEST['zip_kind'] : 0;
...
<form name="form" method="post" action="zipcode.php">
  <input type="hidden" name="zip_kind" value="<?= $zip_kind ?>">
		...
		<a href="javascript:SendZip(form.zip_kind.value);" class="btn btn-sm btn-dark text-white myfont">확 인</a>
